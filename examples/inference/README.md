...
| ----------- | ----------- | ------------ | ----------- | 
| [BAAI BGE Reranker v2 M3](./rayserve/baai-bge-reranker-v2-m3-vllm/serve.ipynb)    | [vLLM](https://github.com/vllm-project/vllm)    | Nvidia GPU | Devices=1, TP=1, PP=1 |
| [DeepSeek R1](./rayserve/deepseek-r1-vllm/serve.ipynb)    | [vLLM](https://github.com/vllm-project/vllm)    | Nvidia GPU | Nodes=6, Devices=8, TP=8, PP=6, Multi-node inference |
