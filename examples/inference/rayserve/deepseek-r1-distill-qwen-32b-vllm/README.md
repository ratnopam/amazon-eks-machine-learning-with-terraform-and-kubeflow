...
This example illustrates how to use [Ray Serve](../../../../charts/machine-learning/serving/rayserve/) Helm chart to serve [deepseek-ai/DeepSeek-R1-Distill-Qwen-32B](https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Qwen-32B) model.
